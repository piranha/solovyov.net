...
TwinSpark approach is obviously much better in most cases for the user: less JavaScript, less jankiness, more common HTML-like behaviour. On a worst day we would serve you 2.5mb of minified (non-gzipped) JS and 700 kb of HTML (half of it were initial data for React) for catalogue. Right now it's 40 kb of minified non-gzipped JS (TwinSpark, analytics, some behaviour, IntersectionObserver polyfill) and 350 kb of HTML. Two orders of magnitude difference and even HTML is smaller! This is just like Christmas in childhood!
