...
Идея того, что писать в голове оформилась довольно давно. Хотя она придумалась и
не специально для соревнования, а в общем "неплохо бы написать", но так как
...
опять написанное отдаю в руки непонятно кому и зачем, и как его оттуда доставать
...
- клиент
  - который уже выглядел не как кошмар эпилептика (и имел симпатичную страницу
...
Ну и заодно переписать сервер, который теперь на реагирует на вебхук от
дропбокса и по изменению данных в нëм скачивает сайт заново и складывает его на
диск.
...
полчаса, как в прошлый рад. Количество траблов при деплое, как всегда,
...
Энивей, к 2 часам ночи всë поехало наконец, я в последний момент добавил Google
Analytics, и мы наконец разъехались спать.
...
ClojureScript хорош. Вот реально, улучшить синтаксис просто на ходу - это
серьëзно улучшающий жизнь момент.
...
стремнее. Но подумать, так ли это, стоит.
...
[прекрасный пост][ab]. Очень приятно прочитать было. :)
